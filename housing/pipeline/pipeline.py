...
class Pipeline(Thread):
    ...
    def __init__(self, config: Configuartion ) -> None:
        try:
            ...
            #daemon=False-->Daemon threads are terminated when the main program finishes.
            #name="pipeline-->assign a name to the thread or process.
    ...
    def start_data_ingestion(self) -> DataIngestionArtifact:
        try:
            ...
            return data_ingestion.initiate_data_ingestion() #-> data ingestion artifact
    ...
    def run_pipeline(self):
        try:
            ...
            #Fetching the results of all the components
