...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            # Loading array values in the transformed_train_file_path
            train_array = load_numpy_array_data(file_path=transformed_train_file_path)

            logging.info(f"Loading transformed testing dataset")
            transformed_test_file_path = self.data_transformation_artifact.transformed_test_file_path
            # Loading array values in the transformed_test_file_path
            ...
            #diff_test_train_acc=self.model_trainer_config.diff_test_train_acc
            ...
            logging.info(f"Evaluation on all trained model on training and testing dataset both")
